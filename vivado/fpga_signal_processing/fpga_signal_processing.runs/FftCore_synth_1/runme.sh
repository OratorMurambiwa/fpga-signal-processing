...
HD_PWD='C:/Users/muram/fpga-signal-processing/vivado/fpga_signal_processing/fpga_signal_processing.runs/FftCore_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FftCore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FftCore.tcl
