...
#
# Script generated by Vivado on Sat Aug 22 00:09:02 -0500 2026
...
#
# Usage        : FftCore.sh
#                FftCore.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FftCore.sh [-rerun]
#                FftCore.sh [-reset_run]
#                FftCore.sh [-clean]
#                FftCore.sh [-reset_log]
#                FftCore.sh [-help]
#
...
# script info
echo -e "FftCore.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FftCore.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_16 -L axi_utils_v2_0_12 -L c_reg_fd_v12_0_12 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_12 -L c_addsub_v12_0_22 -L c_shift_ram_v12_0_21 -L mult_gen_v12_0_25 -L floating_point_v7_1_22 -L cmpy_v6_0_28 -L xfft_v9_1_16 -L secureip -L xpm --snapshot FftCore xil_defaultlib.FftCore -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim FftCore -key {Behavioral:sim_1:Functional:FftCore} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FftCore.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FftCore.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FftCore.sh [-help]\n\
Usage: FftCore.sh [-step]\n\
Usage: FftCore.sh [-lib_map_path]\n\
Usage: FftCore.sh [-rerun]\n\
Usage: FftCore.sh [-reset_run]\n\
Usage: FftCore.sh [-clean]\n\
Usage: FftCore.sh [-reset_log]\n\
Usage: FftCore.sh [-keep_index]\n\
Usage: FftCore.sh [-noclean_files]\n\n\
